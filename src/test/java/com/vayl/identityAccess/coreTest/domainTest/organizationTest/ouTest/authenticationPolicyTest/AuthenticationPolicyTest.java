...
public class AuthenticationPolicyTest {
    ...
    public void equals_sameAttributes_returnTrue() {
        ...
        MfaPolicy mfaPolicy = new MfaPolicy(MfaType.AUTHENTICATOR_APP, new Date("2023-12-01T00:00:00Z"));
    ...
    public void  equals_differentAttributes_returnFalse() {
        ...
        MfaPolicy mfaPolicy1 = new MfaPolicy(MfaType.AUTHENTICATOR_APP, new Date("2023-12-01T00:00:00Z"));
    ...
    public void toString_validAttributes_returnCorrectString() {
        ...
        String expectedString = "AuthenticationPolicy{"
                + "recoveryPolicy=" + recoveryPolicy.toString()
                + ", mfaPolicy=" + mfaPolicy.toString()
                + ", isInherited=" + false
                + '}';
    ...
    @Test
    public void copyWith_changeIsInherited_returnNewInstance() {
        RecoveryPolicy recoveryPolicy = new RecoveryPolicy(MfaType.EMAIL);
        MfaPolicy mfaPolicy = new MfaPolicy(MfaType.AUTHENTICATOR_APP, new Date("2023-12-01T00:00:00Z"));
        AuthenticationPolicy originalPolicy = new AuthenticationPolicy(recoveryPolicy, mfaPolicy, false);
