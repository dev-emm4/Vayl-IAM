...
public class LicenseContractIdTest {
  ...
  public void equals_withSameId_returnsTrue() {
    ...
    LicenseContractId id1 =
        new LicenseContractId(new OrgId(validOrgId), new LicenseId(validLicenseId));
    LicenseContractId id2 =
        new LicenseContractId(new OrgId(validOrgId), new LicenseId(validLicenseId));
  ...
  public void equals_withDifferentId_returnsFalse() {
    ...
    LicenseContractId id1 =
        new LicenseContractId(new OrgId(validOrgId1), new LicenseId(validLicenseId1));
    LicenseContractId id2 =
        new LicenseContractId(new OrgId(validOrgId2), new LicenseId(validLicenseId2));
  ...
  public void toString_returnsCorrectFormat() {
    String validOrgId = UUID.randomUUID().toString();
    String validLicenseId = UUID.randomUUID().toString();
    LicenseContractId id =
        new LicenseContractId(new OrgId(validOrgId), new LicenseId(validLicenseId));
    String expectedString =
        "LicenseContractId{orgId="
            + new OrgId(validOrgId)
            + ", licenseId="
            + new LicenseId(validLicenseId)
            + "}";
